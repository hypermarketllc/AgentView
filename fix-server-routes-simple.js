/**
 * fix-server-routes-simple.js
 * This script directly fixes the server-docker-routes.js file by writing a completely new version.
 */
...
// Create a backup
const backupPath = `${routesPath}.backup.simple`;
console.log(`Creating backup at ${backupPath}...`);
fs.copyFileSync(routesPath, backupPath);

// Write the fixed content directly to the file
console.log('Writing fixed content to the server routes file...');

// Define the fixed content as a string
const fixedContent = `/**
