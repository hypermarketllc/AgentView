/**
 * system-health-monitor-fixed.js
 * 
 ...
 * 
 * This version is updated to use the correct API endpoints.
 */
...
async function checkUserSettings() {
  // Use the direct endpoint path that matches what's in server-docker-fixed.js
  const data = await makeApiRequest('/user/settings');
...
async function checkSystemSettings() {
  // Use the direct endpoint path that matches what's in server-docker-fixed.js
  const data = await makeApiRequest('/settings/system');
...
async function checkCarriers() {
  const data = await makeApiRequest('/carriers');
...
async function checkPositions() {
  const data = await makeApiRequest('/positions');
...
console.log('Starting fixed system health monitor...');
runHealthChecks();
