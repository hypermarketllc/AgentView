...
docker run --name crm-postgres ^
  ...
  -p 5432:5432 ^
  -v "%cd%\supabase-export\create_tables.sql:/docker-entrypoint-initdb.d/01-create_tables.sql" ^
  -v "%cd%\supabase-export\create_auth_tables.sql:/docker-entrypoint-initdb.d/02-create_auth_tables.sql" ^
  -v "%cd%\supabase-export\insert_data.sql:/docker-entrypoint-initdb.d/03-insert_data.sql" ^
  -v "%cd%\setup-db-permissions.sql:/docker-entrypoint-initdb.d/04-setup-permissions.sql" ^
  -d postgres:15
